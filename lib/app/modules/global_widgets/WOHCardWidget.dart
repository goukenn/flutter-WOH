...
class WOHCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.lazyPut<WOHBookingsController>(() => WOHBookingsController());
    //var selected = Get.find<WOHBookingsController>().currentState.value ;
    return ClipRRect(
      child: Banner(
        location: BannerLocation.topEnd,
        message: bookingState == "reserved"
            ? "Planifié"
            : bookingState == "done"
            ? "Fait"
            : bookingState == 'cancel'
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "${DateFormat("dd MMM yyyy, HH:mm").format(DateTime.parse(shippingDateStart))} - ${DateFormat(" HH:mm").format(DateTime.parse(shippingDateEnd))}",
                      style: Get.textTheme.displayLarge!.merge(
