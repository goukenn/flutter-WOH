...
import '../../account/widgets/WOHAccountWidget.dart';
...
class WOHAddShippingForm extends GetView<WOHInspectController> {
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      icon: Icon(
                        ...
                        color: Get.find<WOHAuthController>().isEmployee.value
                            ? employeeInterfaceColor
                            : interfaceColor,
                        size: 35,
                      ),
                    ),
  ...
  CupertinoStepper _buildStepper(StepperType type) {
    ...
    final canContinue = controller.editAppointment.value
        ? controller.formStep.value < 2
        : controller.formStep.value < 4;
    return CupertinoStepper(
      ...
      onStepTapped: (step) {
        ...
        Get.showSnackbar(
          WOHUi.InfoSnackBar(message: "You are currently at step $step"),
        );
      },
                    ...
                    if (!controller.showButton.value) {
                      if (controller.formStep.value == 0) {
                        if (controller.categorySelected.isNotEmpty) {
                          controller.getCategoryHairStyle(
                            controller.categoryDto['service_ids'],
                          );
                          controller.formStep.value++;
                          controller.getCategoryBarber(
                            controller.categoryDto['resource_ids'],
                          );
                        } else {
                          Get.showSnackbar(
                            WOHUi.InfoSnackBar(
                              message:
                                  "Vous devez sélectonner une catégory avant de continuer",
                            ),
                          );
                        }
                      } else {
                        if (controller.formStep.value == 1) {
                          if (controller.serviceSelected.isNotEmpty) {
                            ...
                            Get.showSnackbar(
                              WOHUi.InfoSnackBar(
                                message:
                                    "Vous devez sélectonner une coiffure avant de continuer",
                              ),
                            );
                          }
                        } else {
                          if (controller.formStep.value == 2) {
                            if (controller.employeeSelected.isNotEmpty) {
                              if (controller.daySelected.value != 0) {
                                ...
                                Get.showSnackbar(
                                  WOHUi.warningSnackBar(
                                    message:
                                        "Bien-vouloir choisir une date de rendez-vous",
                                  ),
                                );
                              }
                            } else {
                              Get.showSnackbar(
                                WOHUi.InfoSnackBar(
                                  message:
                                      "Vous devez sélectonner un coiffeur avant de continuer",
                                ),
                              );
                            }
                          } else {
                            if (controller.formStep.value == 3) {
                              if (controller.selectedTime.isNotEmpty) {
                                ...
                                Get.showSnackbar(
                                  WOHUi.InfoSnackBar(
                                    message:
                                        "Bien-vouloir choisir une heure pour votre rendez-vous",
                                  ),
                                );
                              }
                            }
          ...
          for (var i = 0; i < 2; ++i)
            _buildStep(
              ...
              state: i == controller.formStep.value
                  ? StepState.indexed
                  : i < controller.formStep.value
                  ? StepState.complete
                  : StepState.indexed,
            ),
          _buildStep(title: Icon(Icons.check), state: StepState.indexed),
        ] else ...[
          for (var i = 0; i < 4; ++i)
            _buildStep(
              title: Text(''),
      ...
      content: Obx(
        () => controller.editAppointment.value
            ? LimitedBox(
                ...
                child: controller.formStep.value == 0
                    ? build_barberSelection(Get.context!)
                    : controller.formStep.value == 1
                    ? buildAppointmentTime(Get.context!)
            ...
            : LimitedBox(
                ...
                child: controller.formStep.value == 0
                    ? build_Category(Get.context!)
                    : controller.formStep.value == 1
                    ? build_hairStyle(Get.context!)
                    : controller.formStep.value == 2
                    ? build_barberSelection(Get.context!)
                      ...
                      return WOHDelayedAnimation(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (controller.categorySelected.contains(
                              controller.categories[index]['id'],
                            )) {
                          ...
                          child: Obx(
                            () => Container(
                              ...
                              decoration: BoxDecoration(
                                color:
                                    controller.categorySelected.contains(
                                      controller.categories[index]['id'],
                                    )
                                    ? null
                                    : background,
                              ...
                              width: Get.width,
                              height: WOHResponsive.isTablet(context)
                                  ? 200
                                  : 100,
                              child: Row(
                                children: <Widget>[
                                  ClipRRect(
                                    ...
                                    child: FadeInImage(
                                      ...
                                      fit: BoxFit.cover,
                                      image: NetworkImage(
                                        '${WOHConstants.serverPort}/image/business.resource.type/${controller.categories[index]["id"]}/image_1920?unique=true&file_response=true',
            ...
            () => controller.loadServices.value
                ...
                : GridView(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 2,
                      mainAxisExtent: WOHResponsive.isTablet(context)
                          ? 330.0
                          : 230.0,
                    ...
                    children: List<Widget>.generate(controller.services.length, (
                      int index,
                    ) {
                      return WOHDelayedAnimation(
                        delay: index == 0 ? 30 : 30 * index,
                        child: Obx(
                          () => InkWell(
                            onTap: () {
                              ...
                              if (controller.serviceSelected.contains(
                                controller.services[index]['id'],
                              )) {
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color:
                                    controller.serviceSelected.contains(
                                      controller.services[index]['id'],
                                    )
                                    ? background
                                    : WOHPalette.background,
                                border:
                                    controller.serviceSelected.contains(
                                      controller.services[index]['id'],
                                    )
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: FadeInImage(
                                      ...
                                      fit: BoxFit.cover,
                                      image: NetworkImage(
                                        '${WOHConstants.serverPort}/image/appointment.product/${controller.services[index]["id"]}/image_1920?unique=true&file_response=true',
                                        headers: WOHConstants.getTokenHeaders(),
                                      ),
                                      placeholder: AssetImage(
                                        "assets/img/loading.gif",
                                  ...
                                  Text(
                                    controller.services[index]["product_price"]
                                            .toString() +
                                        " €",
                                    style: Get.textTheme.displayMedium,
                                  ),
      ...
      children: [
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () async {
                                ...
                                if (controller.employeeSelected.contains(
                                  controller.employees[index]['id'],
                                )) {
                                  ...
                                  controller.getCalendar(
                                    controller
                                        .employees[index]['info_resource_calendar_id'][0],
                                  );
                                  controller.getAppointments(
                                    controller
                                        .employees[index]['appointment_ids'],
                                  );
                                  list.add(controller.employees[index]["id"]);
                                  controller.employeeSelected.value = list;
                                  controller.employeeDto.value =
                              ...
                              child: Obx(
                                () => Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border:
                                        controller.employeeSelected.contains(
                                          controller.employees[index]['id'],
                                        )
                                        ? Border.all(
                                            width: 3,
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: FadeInImage(
                                          width: Get.width / 4,
                                          height:
                                              WOHResponsive.isTablet(context)
                                              ? 200
                                              : 110,
                                          fit: BoxFit.cover,
                                          image: NetworkImage(
                                            '${WOHConstants.serverPort}/image/hr.employee/${controller.employees[index]["employee_id"][0]}/image_1920?unique=true&file_response=true',
                                            headers:
        ...
        Obx(
          () => Container(
            ...
            color: controller.employeeSelected.isNotEmpty
                ? backgroundColor
                : null,
      ...
      children: <Widget>[
        ...
        Expanded(
          child: GridView(
            ...
            children: List<Widget>.generate(controller.appointTime.length, (
              int index,
            ) {
              var condition = controller.availability.contains(
                controller.getTimeStringFromDouble(
                  controller.appointTime[index],
                ),
              );
              if (controller.editAppointment.value) {
                controller.appointmentEnd.value = controller
                    .getTimeStringFromDouble(
                      controller.appointTime[index] *
                          controller.appointmentDto['duration'] *
                          60 *
                          60,
                    );
              } else {
                controller.appointmentEnd.value = controller
                    .getTimeStringFromDouble(
                      controller.appointTime[index] *
                          controller.serviceDto['appointment_duration'] *
                          60 *
                          60,
                    );
              }
              ...
              return WOHDelayedAnimation(
                ...
                child: Obx(
                  () => InkWell(
                    onTap: () {
                      if (!condition) {
                        controller.timeDto.value = controller
                            .getTimeStringFromDouble(
                              controller.appointTime[index],
                            );
                        var list = [];
                        if (controller.selectedTime.contains(
                          controller.timeDto.value,
                        )) {
                          ...
                          var endTime = DateTime.parse(
                            "2000-09-20 ${controller.selectedTime.join(",")}:00",
                          ).add(Duration(minutes: duration));
                          controller.appointmentEnd.value = DateFormat(
                            "HH:mm",
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: !condition
                            ? controller.selectedTime.contains(
                                    controller.getTimeStringFromDouble(
                                      controller.appointTime[index],
                                    ),
                                  )
                                  ? Get.find<WOHAuthController>()
                                            .isEmployee
                                            .value
                                        ? employeeInterfaceColor
                                        : interfaceColor
        ...
        children: <Widget>[
          ...
          WOHAccountWidget(
            ...
            label: DateFormat("yyyy-MM-dd")
                .format(DateTime.parse(controller.appointmentDate.value))
                .toString(),
          ...
          WOHAccountWidget(
            ...
            text: "TEMPS:",
            label:
                "${controller.timeDto.value} - ${controller.appointmentEnd.value}",
            labelColor: Colors.black,
            textColor: appColor,
          ),
          WOHAccountWidget(
          ...
          WOHAccountWidget(
            ...
            text: "SERVICE:",
            label: !controller.editAppointment.value
                ? controller.serviceDto['name'].split(">").first
                : controller.appointmentDto['service_id'][1].split(">").first,
            labelColor: Colors.black,
            textColor: appColor,
          ),
          if (!controller.editAppointment.value)
          ...
          if (!controller.editAppointment.value)
            Row(
              children: [
                ...
                Spacer(),
                Text(
                  "${controller.serviceDto['product_price']} €",
                  style: TextStyle(
                    fontSize: priceSize,
                    fontWeight: FontWeight.bold,
                    color: Get.find<WOHAuthController>().isEmployee.value
