...
class WOHSettingsBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<WOHSettingsController>(
      () => WOHSettingsController(),
    );
    Get.lazyPut<WOHAddressController>(
      () => WOHAddressController(),
    );
    Get.lazyPut<WOHThemeModeController>(
      () => WOHThemeModeController(),
    );
    Get.lazyPut<WOHLanguageController>(
